/*
  ...
  - You are about to drop the `RechargePlan` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "public"."RechargeOrder" DROP CONSTRAINT "RechargeOrder_planId_fkey";

-- DropForeignKey
ALTER TABLE "public"."RechargeOrder" DROP CONSTRAINT "RechargeOrder_userId_fkey";

-- DropTable
DROP TABLE "public"."RechargeOrder";

-- DropTable
DROP TABLE "public"."RechargePlan";
